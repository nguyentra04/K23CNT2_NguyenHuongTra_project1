                ...
                <div class="card">
                    ...
                    <div class="card-body container-fluid">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" value="{{ $nhtloaisps->NHTTenLoai }}" 
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="radio" id="NHTTrangThai0" name="NHTTrangThai" value="0" {{ $nhtloaisps->NHTTrangThai == 1 ? 'checked' : '' }}>
                                <label for="NHTTrangThai0">Hiển thị</label>
                                &nbsp;
                                <input type="radio" id="NHTTrangThai1" name="NHTTrangThai" value="1" {{ $nhtloaisps->NHTTrangThai == 0 ? 'checked' : '' }}>
